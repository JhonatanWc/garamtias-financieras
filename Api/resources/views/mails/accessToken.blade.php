		...
		<td>
			<table style="background:#fff;  width:600px; margin:0 auto; border:0; border-radius:10px;">
                ...
                <td style="margin:0; padding:50px; line-height:0; text-align:center;">
						<p style="margin:0; padding:0; font-family:Poppins, sans-serif; font-size:16px; color:#3D5553; line-height:21px;">Bienvenido</p>
						<p style="margin:0; padding:0; font-family:Poppins, sans-serif; font-size:16px; color:#3D5553; line-height:21px;">Tu codigo de seguridad es {{$details['token']}}</p>
					</td>
				</tr>
			</table>
		</td>
